...
def BlackSmith(charlie_earth,b_shop_vendor):
    ...
    action('WalkTo('+charlie_earth+',Sword)')
    action('Take('+charlie_earth+',Sword)')
    action('WalkTo('+charlie_earth+', '+b_shop_vendor+')')
    action('Face('+b_shop_vendor+','+charlie_earth+')')
    ...
    action('Wait(3)')
    action('HideNarration')
    action('Exit('+charlie_earth+',Blacksmith.Door')