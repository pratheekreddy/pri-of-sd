...
def MysteryWorld(charlie_earth,f_shop_vendor):
    ...
    action('Enter('+charlie_earth+',FruitShop.Door)')
    action('Take('+charlie_earth+',Apple1')
    action('WalkTo('+charlie_earth+','+f_shop_vendor+')')
